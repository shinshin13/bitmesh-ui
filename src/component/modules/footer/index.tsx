...
const Footer = () => {
  return (
    <div className="relative bg-[url('/src/assets/image/cover.jpg')] bg-no-repeat bg-center bg-cover w-full h-screen">
      <div className="absolute inset-0 bg-[url('/src/assets/image/blue_inside.png')] bg-repeat bg-center"></div>
      <div className="absolute top-0 left-0 right-0 bottom-0 container z-1 max-w-[1128px] mx-auto min-h-dvh flex items-center justify-center px-4">
      ...
      <div className="bg-[#141414] py-12 mt-[100vh] lg:mt-0">
